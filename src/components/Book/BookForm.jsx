...
const BookForm = ({ onAddBook }) => {
  ...
  const fetchAuthors = async () => {
    try {
      const response = await axios.get('https://library-system-backend-apou.onrender.com/api/v1/authors');
  ...
  const fetchPublishers = async () => {
    try {
      const response = await axios.get('https://library-system-backend-apou.onrender.com/api/v1/publishers');
  ...
  const fetchCategories = async () => {
    try {
      const response = await axios.get('https://library-system-backend-apou.onrender.com/api/v1/categories');
